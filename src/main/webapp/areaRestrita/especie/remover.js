$(".remove").click(function () {
    ...
    container.innerHTML = `
        <div class="confirm-box">
            ...
            <p>Você tem certeza que deseja excluir essa espécie?</p>
            <img src="../../assets/images/ModolinhoCorpoCompleto.png" alt="Imagem">
            <form action="especie/remover" method="post" class="confirm-form">
                <input type="hidden" name="id-especie" class="id-especie" value="${id}" readonly>
