$(".remove").click(function () {
    ...
    container.innerHTML = `
        <div class="confirm-box">
            ...
            <p>Você tem certeza que deseja excluir essa raça?</p>
            <img src="../../assets/images/ModolinhoCorpoCompleto.png" alt="Imagem">
            <form action="raca/remover" method="post" class="confirm-form">
                <input type="hidden" name="id-raca" class="id-raca" value="${id}" readonly>
